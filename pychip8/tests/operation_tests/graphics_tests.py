...
class GraphicsTests(OperationTestCase):
    ...
    def test_draw_sprite(self):
        opcode = Opcode(0xD013)

        self.cpu.general_purpose_registers[opcode.x] = 0
        self.cpu.general_purpose_registers[opcode.y] = 1
        ...
        x = self.cpu.general_purpose_registers[opcode.x]
        y = self.cpu.general_purpose_registers[opcode.y]

        self._test_buffer_pixels_match_pattern(x, y, 0b1)
        self._test_buffer_pixels_match_pattern(x, y+1, 0b11)
        self._test_buffer_pixels_match_pattern(x, y+2, 0b111)
        self._test_buffer_pixels_match_pattern(x, y+3, 0b0)
    ...
    def test_draw_collision(self):
        ...
        self._test_buffer_pixels_match_pattern(x, y, 0b1001)
